...
for team in teams:
    ...
    for i,match in matches.iterrows():
        ...
        rows.append([matchdate,goalsfor,goalsagainst,goaldiff,points,profit,seasonst,game])
...
comparison1='Tottenham'
comp_color1='blue'
comparison2='Arsenal'
comp_color2='red'
#comparison3='Man United'
#comp_color3='darkred'
...
ax.legend([comparison1,comparison2])
...
fig.savefig('Output/dip_totars.png', dpi=None, bbox_inches="tight")
